...
\begin{verbatim}
  Grow hierarchy           Shrink hierarchy         Replace hierarchy                  Iterator hierarchy
    ...
    @UnknownGrow             @UnknownShrink           @UnknownReplace                     @UnknownIter
      /      \                 /       \                /       \                              |
 @Growable @Ungrowable   @Shrinkable @Unshrinkable  @Replaceable @Unreplaceable                |
      \      /                 \       /                \       /                              |
    @BottomGrow             @BottomShrink            @BottomReplace                   @IteratorPreserveRemove
\end{verbatim}
  \end{minipage}
...
The bottom qualifier in the Grow hierarchy.  It is a subtype of both
\<@Growable> and \<@Ungrowable>.  Programmers should rarely write it.
...
The bottom qualifier in the Shrink hierarchy.  It is a subtype of both
\<@Shrinkable> and \<@Unshrinkable>.  Programmers should rarely write it.
...
The bottom qualifier in the Replace hierarchy.  It is a subtype of both
\<@Replaceable> and \<@Unreplaceable>.  Programmers should rarely write it.

\item[\refqualclass{checker/modifiability/qual}{UnknownIter}]
...
\item[\refqualclass{checker/modifiability/qual}{IteratorPreserveRemove}]
...
% LocalWords:  UnknownIter IteratorPreserveRemove
